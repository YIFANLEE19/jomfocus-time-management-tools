        ...
        <div class="col-md-8 offset-md-2">
            <form action="{{ route('admin.storeNews') }}" method="post">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="text" class="form-control" id="newsTitle" name="newsTitle" maxlength="52" aria-describedby="titleHelp">
                    <div id="titleHelp" class="form-text">You can enter fewer than 53 characters for a title.</div>
                </div>
                <div class="form-group mt-2">
                    <label for="newsContent" class="form-label">Content</label>
                    <textarea class="form-control" id="newsTextarea" name="newsContent"></textarea>
                </div>
                <button class="admin-btn" type="submit" style="height:50px;">Add news</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    class MyUploadAdapter {
        ...
        _initRequest() {
            ...
            // could be different.
            xhr.open( 'POST', '{{ route('admin.imageUpload') }}', true );
